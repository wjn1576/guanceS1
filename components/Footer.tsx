      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-8 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-gray-600">
              <li><a href="#" className="hover:text-guance-orange">基础设施监控</a></li>
              <li><a href="#" className="hover:text-guance-orange">应用性能监测</a></li>
              <li><a href="#" className="hover:text-guance-orange">日志管理</a></li>
              <li><a href="#" className="hover:text-guance-orange">用户体验监测</a></li>
              <li><a href="#" className="hover:text-guance-orange">CI/CD 可视化</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-gray-600">
              <li><a href="#" className="hover:text-guance-orange">文档中心</a></li>
              <li><a href="#" className="hover:text-guance-orange">博客</a></li>
              <li><a href="#" className="hover:text-guance-orange">开发者社区</a></li>
              <li><a href="#" className="hover:text-guance-orange">客户案例</a></li>
              <li><a href="#" className="hover:text-guance-orange">帮助中心</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-gray-600">
              <li><a href="#" className="hover:text-guance-orange">公司介绍</a></li>
              <li><a href="#" className="hover:text-guance-orange">加入我们</a></li>
              <li><a href="#" className="hover:text-guance-orange">合作伙伴</a></li>
              <li><a href="#" className="hover:text-guance-orange">联系我们</a></li>
              <li><a href="#" className="hover:text-guance-orange">隐私政策</a></li>
            </ul>
            <div className="mt-6">
               <img 
                 src="https://img.remit.ee/api/file/BQACAgUAAyEGAASHRsPbAAEQ4q9pjXaOYwHvrznwkHJ2nI2WPX7sKAACXBwAAoLCaFQwQV-BgutVtDoE.jpg" 
                 alt="Guance QR Code" 
                 className="w-24 h-24 rounded-md border border-gray-100 shadow-sm"
               />
               <p className="text-xs text-gray-400 mt-2">关注官方微信</p>
            </div>
          </div>
        </div>
        ...
        <div className="border-t border-gray-100 pt-8 flex flex-col md:flex-row justify-between items-center text-sm text-gray-500">
          ...
          <div className="flex space-x-6">
            <a href="#" className="hover:text-gray-900">条款</a>
